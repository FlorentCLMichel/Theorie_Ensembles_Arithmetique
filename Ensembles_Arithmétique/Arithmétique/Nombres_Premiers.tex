...
\noindent\textbf{Lemme :}
    ...
    Soit $a'$ et $b'$ les quotients des divisions enclidiennes de $a$ et $b$ par $c$.
    On a : $m = n c a' = o c b'$. 
    Puisque $c \neq 0$, cela implique $n a' = o b'$.
    Donc, $a'$ divise $o b'$.
    Puisque $a'$ et $b'$ sont premiers entre eux, cela impique que $a$ divise $o$.
...
Puisque la multiplication est associative, accoler les séries représentant denx entiers naturels non nuls donne la série représentant leur produit.
...
\begin{itemize}[nosep]
    \item Soit $a$ et $b$ deux entiers naturels non nuls.
        Alors, $a$ est un multiple de $b$ si et seulement si la représentation schématique de $b$ est (possiblement après réarrangements) include dans celle de $a$. \\
