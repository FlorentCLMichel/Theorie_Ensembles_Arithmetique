...
\begin{itemize}[nosep]
    ...
    \item Montrons que $(\mathbb{Q}, \times)$ est un magma associatif :
        \begin{itemize}[nosep]
            \item L'opération $+$ est commutative.
            \item ***
        \end{itemize}
    \item L'opération $\times$ est commutative. 
    ...
    \item \emph{Tout élément de $\mathbb{Q}$ distinct de $0$ admet un inverse pour $\times$ :} 
        ...
        Puisque l'opération $\times$ est commutative, cela montre que $\bar{y}$ est un inverse de $\bar{x}$ pour $\times$.
\end{itemize}
