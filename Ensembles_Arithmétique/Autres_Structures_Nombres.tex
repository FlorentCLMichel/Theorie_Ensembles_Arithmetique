...
\noindent Les deux derniers points peuvente être généralisés comme suit.
...
\noindent\textbf{Lemme :} Soit $u$ et $v$ deux suites de rationnels.
    ...
    \begin{itemize}[nosep]
        \item S'il existe un rationnel $q$ tel que $v_n \geq q$ pour tout entier naturel $n$, alors $u + v$ tends vers $+\infty$.
        \item S'il existe un rationnel strictement positif $q$ et un entier naturel $n$ tel que $v_m \geq q$ pour tout entier naturel $m$ supérieur ou égal à $m$, alors $u \times v$ tends vers $+\infty$.
    \end{itemize}
