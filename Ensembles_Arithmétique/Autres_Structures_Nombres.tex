...
Notons que, sous les hypothèses de l'énoncé, les nombres $q^n$, $q^m$, $q^{n+m}$ et $q^{n m}$.
On procède en trois temps: nous montrerons d'abord ces deux résultats pour des valeures positives de $m$, puis les étendrons séparément au cas où $m$ est stricteent négatif.

***

***

Supposons que $m$ est strictement négatif.
