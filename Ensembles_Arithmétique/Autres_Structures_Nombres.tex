...
\aindex{Numérateur} \aindex{Dénominateur}
...
\noindent\textbf{Définition :} On définit les trois opérations $+$ (\emph{addition}), $-$ (\emph{soustraction}) et $\times$ (\emph{multiplication}) de $\mathbb{Q} \times \mathbb{Q}$ vers $\mathbb{Q}$ et $\divslash$ (\emph{division}) de $\mathbb{Q} \times \mathbb{Q}^*$ vers $\mathbb{Q}$ de la manière suivante. \index{Addition}\index{Soustraction}\index{Multiplication}\index{Division} 
...
\noindent\textbf{Lemme :} Le triplet $(\mathbb{Q}, +, \times)$ est un corps, d'éléments neutre $0$ pour $+$ et $1$ pour $\times$.
        ...
        \begin{itemize}[nosep]
            ...
            \item \emph{L'opération $+$ est associative :} 
                ...
                \begin{equation*} \begin{aligned}
                    ...
                    = \frac{((a \times d) + (c \times b)) \times f + e \times (b \times d)}{(b \times d) \times f} + \frac{e}{f} \\
    ...
    \item \emph{Le nombre rationnel $1$ est neutre pour $\times$ :} 
        ...
        \begin{equation*}
            1 \times \bar{x} = \frac{1}{1} \times \frac{a}{b}
                ...
                = \bar{x}.
        \end{equation*}
        Puisque $\times$ est comutative, cela implique également $\bar{x} \times 1 = \bar{x}$.
    \item L'anneau $(Q, +, \times)$ est non nul puisque $0 \neq 1$ (puisque le nombre rationnel $1$ a pou représentant $(1,1)$, qui n'est pas un représentant de $0$ puisque don numérateur n'est pas nul).
...
\noindent\textbf{Démonstration :} Ce résultat découle essentiellement du fait que $\leq$ est une relation d'ordre total sur $\mathbb{Z}$.
    ...
    \begin{itemize}[nosep]
        ...
        \item Si $x \leq y$ et $y \leq x$, alors $a \, b \, d^2 \leq c \, d \, b^2$ et $c \, d \, b^2 \leq a \, b \, d^2$, donc $a \, b \, d^2 = c \, d \, b^2$.
            ...
            Puisque $b$ et $d$ sont non nuls, $b \times d \neq 0$, donc cela implique $a \times d = c \times b$, et donc $x = y$.
...
\noindent\textbf{Remarque :}
    ...
    La condition $x < y$ est donc équivalente à $a \, b \, d^2 < c \, d \, b^2$.
...
\noindent\textbf{Démonstration :} Soit $a$ et $b$ les numérateur et dénominateur d'un représentant de $x$ et $c$ et $d$ ceux d'un représentant de $y$. 
    ...
    Soit $z$ le nombre rationnel défini parK  : $z = e \divslash f$.
    Montrons que $x < z < y$. 
