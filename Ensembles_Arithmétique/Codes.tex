...
\textattachfile{Ensembles_Arithmétique/Code/is_prime.c}{is\_prime.c}
\inputminted{C}{Ensembles_Arithmétique/Code/is_prime.c}

\medskip

\noindent Version Rust du test de primalité: 
\textattachfile{Ensembles_Arithmétique/Code/is_prime.rs}{is\_prime.rs}
...
\noindent Version C: 
\textattachfile{Ensembles_Arithmétique/Code/pgcd.c}{pgcd.c}
\inputminted{C}{Ensembles_Arithmétique/Code/pgcd.c}

\medskip

\noindent Version Rust: 
\textattachfile{Ensembles_Arithmétique/Code/pgcd.rs}{pgcd.rs}
...
\noindent Version C++: 
\textattachfile{Ensembles_Arithmétique/Code/Érastosthène.cpp}{Érastosthène.cpp}
...
\textattachfile{Ensembles_Arithmétique/Code/Érastosthène.rs}{Érastosthène.rs}
