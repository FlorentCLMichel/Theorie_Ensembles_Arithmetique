...
\noindent\textbf{Lemme (induction \aindex{transfinie}) :}
...
On dit que $f$ est \textit{définie sur} $X$, ou que $X$ est le \textit{domaine de définition}\index{Domainde de définition} de $f$. 
