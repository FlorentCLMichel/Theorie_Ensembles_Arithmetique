...
\noindent\textbf{Démonstration :} 
    ...
    Donc, $((a \subset b) \wedge (b \subset a)) \Leftrightarrow (a = b)$ est équivalente à $\mathrm{V}$.
...
\noindent\textbf{Démonstration bis :} 
    \begin{itemize}[nosep]
        \item Notons $P_1$ et $P_2$ les prédicats à un paramètre libre suivants : $P_1(x): x \in E \cup \emptyset$, $P_2(x): x \in E$. 
            ...
            Donc, $P_1 \Leftrightarrow P_2$ est éqiovalent à $\mathrm{V}$.
        ...
        \item Notons $P_1$ le prédicat : $P_1(x): x \in E \cap \emptyset$. 
            ...
            Puisque $\exists x \, x \in \emptyset$ est fausse, $P_1$ est équivalent à $\mathrm{F}$, et donc à $x \in \emptyset$.
            Donc, $\P_1 \Leftrightarrow (x \in \emptyset)$ est équivalent à $\mathrm{V}$.
