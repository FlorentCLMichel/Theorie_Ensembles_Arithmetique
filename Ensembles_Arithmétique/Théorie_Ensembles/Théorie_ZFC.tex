...
\noindent\textit{\textbf{Énoncé :} \aindex{Choix (axiome)} Pour tout ensemble $X$ d'ensembles non vides, il existe une fonction sur $X$ qui à chaque ensemble $x$ appartenant à $X$ associe un élément de $x$ :}
\begin{equation*}
...
\subsubsection{Théorie de Tarski-Grothendieck}

\aindex{Tarski-Grothendieck}
