...
On en déduit que $y$ ne peut appartenir à aucun sous-ensembele conforme de $X$. 

Noton $U$ l'union de tous les sous-ensembles conformes de $X$.%
\footnote{
    ...
    \begin{itemize}
        ...
        \item Montrons que $\leq$ est un bon ordre sur $U$, et donc que $U$ est une chaine.
            ...
            \begin{itemize}[nosep]
                ...
                \item Sinon, $u < a$ est faux, sans quoi $u$ n'appartiendrait à aucun sous-enemble conforme de $X$, et donc n'appartiendrait pas à $U$.
            \end{itemize}
