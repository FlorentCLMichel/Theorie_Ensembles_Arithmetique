...
\begin{itemize}[nosep]
    \item \emph{Réflexivité :} Soit $g$ un élément de $G$.
        Alors, $g^{-1} \cdot g$ et l'élément neutre de $(G, +)$, donc appartient à $H$.
        Donc, $g R g$.
...
\noindent\textbf{Notation :} Soit $(G, \cdot)$ un groupe et $(H, \cdot)$ un sous-groupe normal de $(G, \cdot)$.
    L'ensemble quotient $E \divslash R_L$, où $R_L$ est définie comme ci-dessus, est noté $E \divslash H$.

\medskip

\noindent\textbf{Définition :} Soit $(G, \cdot)$ un groupe et $(H, \cdot)$ un sous-groupe normal de $(G, \cdot)$.
    On définit la loi de composition interne $\cdot$ sur $E \divslash H$ comme suit.
    Soit $F$ et $F$ deux éléments de $E \divslash H$.
    Soit $e$ un élément de $e$ et $f$ un élément de $F$.
    Alors, $E \cdot F$ est l'élément de $E \divslash H$ contenant $e \times f$.
