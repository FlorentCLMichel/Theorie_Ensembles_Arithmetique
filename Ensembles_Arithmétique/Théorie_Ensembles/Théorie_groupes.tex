...
\noindent\textbf{Définition (\aindex{Élément neutre}) :} Soit $(M,\cdot)$ un magma.
...
\noindent\textbf{Définition (\aindex{Isomorpisme de magmas}) :} Soit $\mathcal{M}$ et $\mathcal{N}$ deux magmas.
...
\noindent\textbf{Définition (\aindex{Isomorpisme de monoïdes}) :} Un isomorphisme de magmas d'un monoïde vers un autre est dit \textit{isomorphisme de monoïdes}.
