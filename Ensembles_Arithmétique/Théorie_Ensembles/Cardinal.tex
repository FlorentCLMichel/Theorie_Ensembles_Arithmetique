...
\noindent\textbf{Définition :} Soit $\mathcal{E}$ l'ensemble des fonctions d'une partie de $\mathbb{N}$ vers $\mathbb{N}$. 
    ...
    \begin{itemize}[nosep]
        ...
        (Cela est une bonne définition car tout sous-ensemble de $\mathbb{N}$ de cardinal $n+1$ peut s'écrire sous cette forme%
        \footnote{
            Soit $E$ un ensemble de cardinal $n+1$. 
