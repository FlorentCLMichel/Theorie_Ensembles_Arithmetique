...
\begin{itemize}
    ...
    \item si $x$ est une variable et $f$ une formule, si $\forall x \, f$ est vraie, alors $f$ est équivalente à $\mathrm{V}$ ; 
...
\begin{itemize}
    ...
    \item pour toute variable $x$ et toute formule $f$, la formule $\exists x \, f$ est équivalente à $\neg (\forall x \, \neg f)$.
