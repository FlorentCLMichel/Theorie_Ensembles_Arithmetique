...
\begin{itemize}[nosep]
    ...
    \item Si $n$ est un entier naturel et $x_1$, $x_2$, ..., $x_n$ sont des symboles, le nombre associé à la formule $x_1 x_2 \dots x_n$ est $p_1^{x_1} \times p_2^{x_2} \times \cdots p_n^{x_n}$.
        Plus formellement, $\mathbf{G}(x_1 x_2 \dots x_n) = \prod_{i=1}^n p_i^{x_i}$. 
\end{itemize}
...
On peut ainsi définir la fonction $\mathrm{Dem}$ de $\mathbb{N} \times \mathbb{N}$ vers ${0, 1}$, illustrant que « $n$ démontre $m$ », par : pour tous entiers naturel $n$ et $m$, 
\begin{itemize}[nosep]
...
Montrons un peu plus formellement que $Z$ est démontrable si et seulement si elle est fausse.
\begin{itemize}[nosep]
