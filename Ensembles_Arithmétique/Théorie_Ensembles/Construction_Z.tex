...
\noindent\textbf{Lemme :} Soit $a$ et $b$ deux entiers. 
    Alors, $(a \leq b) \Leftrightarrow ((-b) \leq (-a))$. 

\medskip

\noindent\textbf{Démonstration :} 
On peut choisir deux éléments $\alpha$ et $\beta$ de $\lbrace 0, 1 \rbrace$ et deux éléments $n$ et $m$ de $\mathbb{N}$ tels que $a = (\alpha, n)$ et $b = (\beta, m)$.
Considérons les quatre cas possibles.
\begin{itemize}[nosep]
    \item Si $\alpha = \beta = 0$, alors $a \leq b$ est équivalent à $n \leq m$.
        Puisque $-a = (1, n)$ et $-b = (1, m)$, $-b \leq -a$ est équivalent à $n \leq m$.
        Donc, $a \leq b$ est équivalent à $-b \leq -a$.
    \item Si $\alpha = 0$ et $\beta = 1$, alors $a \leq b$ est faux et $-b \leq -a$ est faux (puisque $\mathrm{sgn}(-b) = 0$ et $\mathrm{sgn}(-a) = 1$). 
    \item Si $\alpha = 1$ et $\beta = 0$, alors $a \leq b$ est vrai et $-b \leq -a$ est vrai (puisque $\mathrm{sgn}(-b) = 1$ et $\mathrm{sgn}(-a) = 0$). 
    \item Si $\alpha = \beta = 0$, alors $a \leq b$ est équivalent à $m \leq n$.
        Puisque $-a = (0, n)$ et $-b = (0, m)$, $-b \leq -a$ est équivalent à $m \leq n$.
        Donc, $a \leq b$ est équivalent à $-b \leq -a$.
\end{itemize}
Dans tous les cas, $a \leq b$ et $-b \leq -a$ ont bien la même valeur de vérité.

\done

\medskip

\noindent\textbf{Corrolaire :} Soit $a$ et $b$ deux entiers. 
    Puisque $(-a = -b) \Leftrightarrow a = b$, on a aussi $(a < b) \Leftrightarrow ((-b) < (-a))$.
