...
On définit l'ensemble $\mathbb{Z}$\sindex[isy]{$\mathbb{Z}$} par : 
\begin{equation*}
...
\index{Valeur absolue} \sindex[isy]{$\abs{\cdot}$}
...
\begin{itemize}[nosep]
    \item \textit{positif}\index{Positif} si $x \geq 0$,
    \item \textit{négatif}\index{Négatif} si $x \leq 0$,
