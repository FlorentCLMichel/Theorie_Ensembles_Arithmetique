...
\noindent\textbf{Définition :} Soit $E$ un ensemble non vide. 
    ...
    Si $u$ est une suite et $n$ une variable, dans la formule $u_n$, $n$ est parfois appelé \textit{index}.
...
On définit les deux fonctions $\mathrm{min}$ et $\mathrm{max}$ sur $\mathbb{N}^2$ de la manière suivante : si $a$ et $b$ sont deux entiers naturels, alors 
\begin{equation*}
