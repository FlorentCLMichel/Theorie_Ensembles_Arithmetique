\startchapter[title=Implémentation de quelques algorithmes]
  ...
  \startnotmode[export] 
    \define[2]\PrintCodeFile{%
      \startframed[frame=off,align=right]
        \offset[y=-1.7ex]{\color[linkcolor]{\bold{\sans{\scale[xscale=1200,yscale=1400]{%
          \attachment[file={Ensembles_Arithmetique/Code/#2}, 
          title={#2}, 
          symbol={#2}]}}}}}
  ...
  \startmode[export] 
    \define[2]\PrintCodeFile{%
      \startframed[frame=off,align=right]
        \href{\bold{\sans{#2}}}{file:Ensembles_Arithmetique/Code/#2}
        \vskip{-3ex}\blank[samepage]
        \typefile[#1]{Ensembles_Arithmetique/Code/#2}
      \stopframed}
  \stopmode
