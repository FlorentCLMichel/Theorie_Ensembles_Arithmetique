...
\startsubsection[title=Décomposition en produit de facteurs premiers, sub:dec_fact_prem]
...
\noindent\bold{Remarque :} Le dernier résultat n'est pas vrai en général si $s$ et $p-1$ ne sont pas premiers entre eux.
    ...
    Puisque $g > 1$, $m < p-1$. 
    Puisque le groupe $(\mathbb{Z} \divslash (p \mathbb{Z}))^*$ est cyclique (voir \in{section}{}[subsubsec:cyclicity_Z_pZ]), il admet au moins un générateur. 
