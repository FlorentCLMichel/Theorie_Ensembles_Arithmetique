\startsection[title=Les groupes $\mathbb{Z}$ modulo un entier positif]

\startsubsection[title=Groupe additif, reference=sec:def_Z_nZ]
...
\startsubsection[title=Groupes multiplicatifs]
