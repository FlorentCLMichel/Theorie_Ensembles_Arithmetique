\startsection[title=Quelques groupes finis]

\startsubsection[title=Groupe additif d'entiers, reference=sec:def_Z_nZ]
...
\noindent\bold{Lemme :} $R_n$ est une relation d'équivalence sur $\mathbb{Z}$. 
...
\noindent\bold{Définition :} On note $\mathbb{Z} \divslash (n \mathbb{Z})$, ou plus simplement $\symbols{\mathbb{Z}_n}$, l'ensemble des classes d'équivalence de la relation $R_n$.

\blank[medium]

\noindent\bold{Lemme :} Le cardinal de $\mathbb{Z}_n$ est $n$.
...
\noindent\bold{Démonstration :}
    ...
    \stopitemize
    Ainsi, $f$ est une bijection de $n$ vers $\mathbb{Z}_n$.
...
\noindent\bold{Définition :} On définit les deux lois de composition interne $+$ et $\times$ sur $\mathbb{Z}_n$ de la manière suivante.
...
\noindent\bold{Lemme :} Dans cette définition, les résultats des opérations $+$ et $\times$ ne dépendent pas du choix des éléments de $A$ et $B$.

\blank[medium]

\noindent\bold{Démonstration :} Avec les mêmes notations, soit $a$ et $a'$ deux éléments de $A$ et $b$ et $b'$ deux éléments de $B$.
...
\noindent\bold{Lemme :} Le magma $\left( \mathbb{Z}_n, + \right)$ est un group abélien. 
...
\startitemize[nowhite]
    ...
    \item Soit $A$ un élément de $\mathbb{Z}_n$. 
...
\noindent\bold{Lemme :} Le triplet $\left( \mathbb{Z}_n, +, \times \right)$ est un anneau commutatif et unifère. 
...
À titre d'exemple, les tables d'addition et de multiplication dans $(\mathbb{Z}_10, +, \times)$ sont données \in{tableau}{}[tab:Z10]. 
Les \in{figures}{}[fig:ZqZ_circle] et~\in{}{}[fig:ZqZ_circle_add] montrent une représentation géométrique de $\mathbb{Z}_n$ pour quelques valeurs de $n$ ainsi que de l'addition sur $(\mathbb{Z}_n, +)$.

\setvariable{myvars}{fTableNLeftCols}{1}
\startplacetable[
    location=force,
    title={Tables d'addition (gauche) et de multiplication (droite) dans $\mathbb{Z}_{10}$.
           Chaque élément de $\mathbb{Z}_{10}$ est représenté par son unique élément dans $[\![0, 9]\!]$.},
    reference=tab:Z10,
    width=35em
  ]
  \startcombination [nx=2,ny=1,distance=3em]
    {\bTABLE[setups=fTable]
      \bTR\bTD $+$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\eTR
      \bTR\bTD $0$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\eTR
      \bTR\bTD $1$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\eTR
      \bTR\bTD $2$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\eTR
      \bTR\bTD $3$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\eTR
      \bTR\bTD $4$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\eTR
      \bTR\bTD $5$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\eTR
      \bTR\bTD $6$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\eTR
      \bTR\bTD $7$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\eTR
      \bTR\bTD $8$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\eTR
      \bTR\bTD $9$ \eTD\bTD $9$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\eTR
    \eTABLE}{}
    {\bTABLE[setups=fTable]
      \bTR\bTD $\times$ \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\eTR
      \bTR\bTD $0$      \eTD\bTD $0$ \eTD\bTD $0$ \eTD\bTD $0$ \eTD\bTD $0$ \eTD\bTD $0$ \eTD\bTD $0$ \eTD\bTD $0$ \eTD\bTD $0$ \eTD\bTD $0$ \eTD\bTD $0$ \eTD\eTR
      \bTR\bTD $1$      \eTD\bTD $0$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\bTD $5$ \eTD\bTD $6$ \eTD\bTD $7$ \eTD\bTD $8$ \eTD\bTD $9$ \eTD\eTR
      \bTR\bTD $2$      \eTD\bTD $0$ \eTD\bTD $2$ \eTD\bTD $4$ \eTD\bTD $6$ \eTD\bTD $8$ \eTD\bTD $0$ \eTD\bTD $2$ \eTD\bTD $4$ \eTD\bTD $6$ \eTD\bTD $8$ \eTD\eTR
      \bTR\bTD $3$      \eTD\bTD $0$ \eTD\bTD $3$ \eTD\bTD $6$ \eTD\bTD $9$ \eTD\bTD $2$ \eTD\bTD $5$ \eTD\bTD $8$ \eTD\bTD $1$ \eTD\bTD $4$ \eTD\bTD $7$ \eTD\eTR
      \bTR\bTD $4$      \eTD\bTD $0$ \eTD\bTD $4$ \eTD\bTD $8$ \eTD\bTD $2$ \eTD\bTD $6$ \eTD\bTD $0$ \eTD\bTD $4$ \eTD\bTD $8$ \eTD\bTD $2$ \eTD\bTD $6$ \eTD\eTR
      \bTR\bTD $5$      \eTD\bTD $0$ \eTD\bTD $5$ \eTD\bTD $0$ \eTD\bTD $5$ \eTD\bTD $0$ \eTD\bTD $5$ \eTD\bTD $0$ \eTD\bTD $5$ \eTD\bTD $0$ \eTD\bTD $5$ \eTD\eTR
      \bTR\bTD $6$      \eTD\bTD $0$ \eTD\bTD $6$ \eTD\bTD $2$ \eTD\bTD $8$ \eTD\bTD $4$ \eTD\bTD $0$ \eTD\bTD $6$ \eTD\bTD $2$ \eTD\bTD $8$ \eTD\bTD $5$ \eTD\eTR
      \bTR\bTD $7$      \eTD\bTD $0$ \eTD\bTD $7$ \eTD\bTD $4$ \eTD\bTD $1$ \eTD\bTD $8$ \eTD\bTD $5$ \eTD\bTD $2$ \eTD\bTD $9$ \eTD\bTD $6$ \eTD\bTD $3$ \eTD\eTR
      \bTR\bTD $8$      \eTD\bTD $0$ \eTD\bTD $8$ \eTD\bTD $6$ \eTD\bTD $4$ \eTD\bTD $2$ \eTD\bTD $0$ \eTD\bTD $8$ \eTD\bTD $6$ \eTD\bTD $4$ \eTD\bTD $2$ \eTD\eTR
      \bTR\bTD $9$      \eTD\bTD $0$ \eTD\bTD $9$ \eTD\bTD $8$ \eTD\bTD $7$ \eTD\bTD $6$ \eTD\bTD $5$ \eTD\bTD $4$ \eTD\bTD $3$ \eTD\bTD $2$ \eTD\bTD $1$ \eTD\eTR
    \eTABLE}{}
 \stopcombination
\stopplacetable
...
\def\maxN{8}
\startplacefigure[
    reference=fig:ZqZ_circle,
    title={Illustration des groupes $\mathbb{Z}_n$ pour $n$ décrivant $[\![1, \maxN]\!]$. 
        ...
        Pour tout élément $\bar{m}$ de $\mathbb{Z}_n$, la fonction $x \mapsto x + \bar{m}$ est alors équivalente à une rotation d'une fraction $m \divslash n$ de cercle (soit $2 \pi m \divslash n$ radians, ici dans le sens horaire), où $m$ est un représentant de $\bar{m}$ (voir \in{figure}{}[fig:ZqZ_circle_add]).}
]
  \startimage
    \starttikzpicture
        \def\figHSpace{4}
...
\def\valN{6}
\startplacefigure[
    reference=fig:ZqZ_circle_add,
    title={Illustration de l'addition sur $\mathbb{Z}_6$, sous la représentation de la \in{figure}{}[fig:ZqZ_circle].}
]
  \startimage
    \starttikzpicture
        \def\figHSpace{5}
...
\noindent\bold{Lemme :} Si $n$ est un nombre premier, le triplet $\left( \mathbb{Z}_n, +, \times \right)$ est un corps. 
...
\noindent\bold{Lemme :} Si $n$ n'est pas un nombre premier, le triplet $\left( \mathbb{Z}_n, +, \times \right)$ n'est pas un corps. 
...
\noindent\bold{Démonstration :} 
    ...
    Sinon, et si $n$ n'est pas premiers, on peut choisir deux entiers naturels $p$ et $q$ tels que $p < n$, $q < n$ et $p \times q = n$ (par example, on peut prendre pour $p$ un diviseur premier de $n$ et $q = n \ds p$).
...
\noindent\bold{Remarque :} La dernière partie de la démonstration montre que, si $n$ est strictement supérieur à $1$ et n'est pas un nombre premier, alors $\times$ ne définit pas une loi de composition interne sur $\mathbb{Z}_n \setminus \lbrace \bar{0} \rbrace$.

\stopsubsection

\startsubsection[title=Groupes multiplicatifs d'entiers]

Soit $n$ un entier naturel non nul. 
On définit l'enemble $\left( \mathbb{Z} \divslash (n \mathbb{Z}) \right)^*$, aussi noté $\symbols{\mathbb{Z}_n^*}$, comme le sous-ensemble de $\mathbb{Z}_n$ défini comme suit : pour tout élément $z$ de $\mathbb{Z}_n$, soit $x$ un représentant de $z$, alors $z \in \mathbb{Z}_n^*$ si et seulement si $\mathrm{pgcd}(\abs{x}, n) = 1$.
...
\noindent
\bold{Lemme :} Soit $n$ un entier naturel non nul. Alors $\left( \mathbb{Z}_n, \times \right)$ est un groupe abélien, d'élément neutre $\bar{1}$.

\blank[medium]

\noindent
\bold{Démonstration :} Notons que $\bar{1} \in \mathbb{Z}_n^*$ puisque le plus grand diviseur de $1$ est $1$ lui-même, donc $\mathrm{pgcd}(1, n) = 1$. 
\startitemize[nowhite]
...
\startplacetable[
    location=force,
    title={Tables de multiplication dans $\mathbb{Z}_5^*$ (gauche) et $\mathbb{Z}_{10}^*$ (droite). 
           Chaque élément de $\mathbb{Z}_n^*$ est repréenté par son unique élément dans $[\![0, n-1]\!]$ pour $n \in \lbrace 5, 10 \rbrace$.},
    reference={tab:Z10star},
    width=35em
  ]
  \startcombination [nx=2,ny=1,distance=3em]
    {\bTABLE[setups=fTable]
      \bTR\bTD $\times$ \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\eTR
      \bTR\bTD $1$      \eTD\bTD $1$ \eTD\bTD $2$ \eTD\bTD $3$ \eTD\bTD $4$ \eTD\eTR
      \bTR\bTD $2$      \eTD\bTD $2$ \eTD\bTD $4$ \eTD\bTD $1$ \eTD\bTD $3$ \eTD\eTR
      \bTR\bTD $3$      \eTD\bTD $3$ \eTD\bTD $1$ \eTD\bTD $4$ \eTD\bTD $2$ \eTD\eTR
      \bTR\bTD $4$      \eTD\bTD $4$ \eTD\bTD $3$ \eTD\bTD $2$ \eTD\bTD $1$ \eTD\eTR
    \eTABLE}{}
    {\bTABLE[setups=fTable]
      \bTR\bTD $\times$ \eTD\bTD $1$ \eTD\bTD $3$ \eTD\bTD $7$ \eTD\bTD $9$ \eTD\eTR
      \bTR\bTD $1$      \eTD\bTD $1$ \eTD\bTD $3$ \eTD\bTD $7$ \eTD\bTD $9$ \eTD\eTR
      \bTR\bTD $3$      \eTD\bTD $3$ \eTD\bTD $9$ \eTD\bTD $1$ \eTD\bTD $7$ \eTD\eTR
      \bTR\bTD $7$      \eTD\bTD $7$ \eTD\bTD $4$ \eTD\bTD $9$ \eTD\bTD $3$ \eTD\eTR
      \bTR\bTD $9$      \eTD\bTD $9$ \eTD\bTD $7$ \eTD\bTD $3$ \eTD\bTD $1$ \eTD\eTR
    \eTABLE}{}
  \stopcombination
\stopplacetable
...
\startsubsection[title=Cyclicité du groupe multiplicatif modulo un nombre premier, reference=subsec:cyclicity_Z_pZ]
