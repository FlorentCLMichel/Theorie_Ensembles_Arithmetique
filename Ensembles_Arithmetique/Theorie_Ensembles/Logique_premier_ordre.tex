...
La \emph{\words{logique du premier ordre}}, aussi appelée \emph{logique des prédicats} ou \emph{calcul des prédicats du premier ordre}, est un cadre \hboxExport{semi-formel}%
...
\startplacetable[location=force,number=no]
  \starttabulate[|c|c|c|c|c|c|c|c|][rulethickness=0.8pt,distance={0pt,0pt}]
    ...
    \NC\NC\VL\NC\NC\NC\NC\NC\NC\NR\TB[-2ex]
    \NC $\mathss{F}$ \NC $\mathss{F}$ \VL $\mathss{V}$ \NC $\mathss{F}$ \NC $\mathss{F}$ \NC $\mathss{V}$    \NC $\mathss{V}$     \NC $\mathss{V}$ \NC\NR
    \NC $\mathss{F}$ \NC $\mathss{I}$ \VL $\mathss{V}$ \NC $\mathss{F}$ \NC $\mathss{I}$ \NC $\mathss{V}$    \NC $\mathss{I}$     \NC $\mathss{I}$ \NC\NR
    \NC $\mathss{F}$ \NC $\mathss{V}$ \VL $\mathss{V}$ \NC $\mathss{F}$ \NC $\mathss{V}$ \NC $\mathss{V}$    \NC $\mathss{F}$     \NC $\mathss{F}$ \NC\NR
    \NC $\mathss{I}$ \NC $\mathss{F}$ \VL $\mathss{I}$ \NC $\mathss{F}$ \NC $\mathss{I}$ \NC $\mathss{I}$    \NC $\mathss{V}$     \NC $\mathss{I}$ \NC\NR
    \NC $\mathss{I}$ \NC $\mathss{I}$ \VL $\mathss{I}$ \NC $\mathss{I}$ \NC $\mathss{I}$ \NC $\mathss{I}$    \NC $\mathss{I}$     \NC $\mathss{I}$ \NC\NR
    \NC $\mathss{I}$ \NC $\mathss{V}$ \VL $\mathss{I}$ \NC $\mathss{I}$ \NC $\mathss{V}$ \NC $\mathss{V}$    \NC $\mathss{I}$     \NC $\mathss{I}$ \NC\NR
    \NC $\mathss{V}$ \NC $\mathss{F}$ \VL $\mathss{F}$ \NC $\mathss{F}$ \NC $\mathss{V}$ \NC $\mathss{F}$    \NC $\mathss{V}$     \NC $\mathss{F}$ \NC\NR
    \NC $\mathss{V}$ \NC $\mathss{I}$ \VL $\mathss{F}$ \NC $\mathss{I}$ \NC $\mathss{I}$ \NC $\mathss{I}$    \NC $\mathss{V}$     \NC $\mathss{I}$ \NC\NR
    \NC $\mathss{V}$ \NC $\mathss{V}$ \VL $\mathss{F}$ \NC $\mathss{V}$ \NC $\mathss{V}$ \NC $\mathss{V}$    \NC $\mathss{V}$     \NC $\mathss{V}$ \NC\NR
  \stoptabulate
\stopplacetable
...
De manière générale (et une fois une théorie de l'arithmétique construite, voir section~\ref{sec:arithmetique} ; on se limite ici aux entiers naturels), une \emph{numérotation de Gödel} est une fonction injective (une définition rigoureuse des fonctions dans le cadre de la théorie des ensembles sera donnée \in{section}{}[sec:fonctions]) associant un nombre à chaque symbole ou formule. 
