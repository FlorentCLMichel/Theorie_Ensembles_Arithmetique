...
\startitemize
  ...
  \item Le symbole $\lnot$ représente la négation : si $P$ est une proposition, la proposition $\lnot P$ est fausse si $P$ est vraie et inversement. 
    ...
    \startplacetable[location=force,number=no]
      \bTABLE[setups=fTable]
        \bTR\bTD $P$          \eTD\bTD $\lnot P$     \eTD\eTR
        \bTR\bTD $\mathss{V}$ \eTD\bTD $\mathss{F}$ \eTD\eTR
        \bTR\bTD $\mathss{I}$ \eTD\bTD $\mathss{I}$ \eTD\eTR
        \bTR\bTD $\mathss{F}$ \eTD\bTD $\mathss{V}$ \eTD\eTR
      \eTABLE
    \stopplacetable
  \item Les symboles $\wedge$ et $\vee$ représentent respectivement les connecteurs « et » et « ou ». 
    ...
    \startplacetable[location=force,number=no]
      \bTABLE[setups=fTable]
        \bTR\bTD $P$          \eTD\bTD $Q$          \eTD\bTD $P \wedge Q$ \eTD\bTD $P \vee Q$   \eTD\bTD $P \Rightarrow Q$ \eTD\bTD $P \Leftarrow Q$ \eTD\bTD $P \Leftrightarrow Q$ \eTD\eTR
        \bTR\bTD $\mathss{V}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{V}$      \eTD\bTD $\mathss{V}$     \eTD\bTD $\mathss{V}$          \eTD\eTR 
        \bTR\bTD $\mathss{V}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{I}$      \eTD\bTD $\mathss{V}$     \eTD\bTD $\mathss{I}$          \eTD\eTR 
        \bTR\bTD $\mathss{V}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{F}$      \eTD\bTD $\mathss{V}$     \eTD\bTD $\mathss{F}$          \eTD\eTR 
        \bTR\bTD $\mathss{I}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{V}$      \eTD\bTD $\mathss{I}$     \eTD\bTD $\mathss{I}$          \eTD\eTR 
        \bTR\bTD $\mathss{I}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{I}$      \eTD\bTD $\mathss{I}$     \eTD\bTD $\mathss{I}$          \eTD\eTR 
        \bTR\bTD $\mathss{I}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{I}$      \eTD\bTD $\mathss{V}$     \eTD\bTD $\mathss{I}$          \eTD\eTR 
        \bTR\bTD $\mathss{F}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{V}$ \eTD\bTD $\mathss{V}$      \eTD\bTD $\mathss{F}$     \eTD\bTD $\mathss{F}$          \eTD\eTR 
        \bTR\bTD $\mathss{F}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{I}$ \eTD\bTD $\mathss{V}$      \eTD\bTD $\mathss{I}$     \eTD\bTD $\mathss{I}$          \eTD\eTR 
        \bTR\bTD $\mathss{F}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{F}$ \eTD\bTD $\mathss{V}$      \eTD\bTD $\mathss{V}$     \eTD\bTD $\mathss{V}$          \eTD\eTR 
      \eTABLE
    \stopplacetable
...
\noindent\bold{NB:} Si on inclus la valeur de vérité « indéfinie » dans la théorie, alors cette démonstration montre seulement que, avec les mêmes notations, la propriété $P$ est indéfinie.
