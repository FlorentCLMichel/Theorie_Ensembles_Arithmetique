...
\noindent\bold{Définition (\words{Magma}) :} Un \emph{\words{magma}} $\mathcal{M}$ est un couple formé par un ensemble $M$ et une \emph{loi de composition interne} $\cdot$ sur $M$ (parfois appelée \emph{opération}), c'est-à-dire une fonction de $M \times M$ vers $M$. 
