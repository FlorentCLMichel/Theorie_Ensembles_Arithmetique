...
\startitemize
    ...
    \item Soit $g$, $g'$ et $x$ trois éléments de $G$. 
        Alors, $\mathss{trans}(g', \mathss{trans}(g,x)) = g' \cdot (g \cdot x) = (g' \cdot g) \cdot x = \mathss{trans}(g' \cdot g, x)$ et $\mathss{conj}(g', \mathss{conj}(g,x)) = g' \cdot ((g \cdot (x \cdot g^{-1})) \cdot g'^{-1}) = (g' \cdot g) \cdot (x (\cdot g^{-1} \cdot g'^{-1})) = (g' \cdot g) \cdot (x \cdot (g' \cdot g)^{-1}) = \mathss{conj}(g' \cdot g, x)$.
\stopitemize
