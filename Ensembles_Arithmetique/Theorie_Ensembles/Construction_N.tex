...
Les premiers entiers sont notés de la manière suivante en base $10$ (voir \in{section}{}[sec:base] pour une définition générale de la base) : 
...
(Notons que cela est cohérent avec les notations définies \in{section}{}[sub:fonctions])
