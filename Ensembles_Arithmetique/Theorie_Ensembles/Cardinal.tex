...
\noindent\bold{Exemple d'application :} \reference[{N_to_N2}]{Bijection entre $\mathbb{N}$ et $\mathbb{N}^2$.} 
\startitemize[nowhite]
...
\noindent\bold{\reference[{F_N_0_1_non_denombrable}]{Contre-exemple :}} En guise d'exemple d'ensembles qui ne sont pas en bijection, considérons les ensembles $\mathbb{N}$ et $\mathcal{F}(\mathbb{N}, \lbrace 0, 1 \rbrace)$. 
