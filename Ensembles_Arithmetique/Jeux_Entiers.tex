\startchapter[title=Jeux avec les entiers]
  ...
  \startsection[title=Décomposition des premiers entiers en produits de facteurs premiers]
    \startcolumns[n=5,separator=rule,frame=off,balance=no,distance=1em]
      \setupindenting[no]
        ...
        \starttikzpicture
          \startaxis[
            ...
            \addplot[fill=dotcolor, draw=dotcolor, only marks, mark size=.5pt] 
              table[col sep=space, header=false, x index=0, y index=1] {{Ensembles_Arithmetique/Code/output_n_divisors_2.csv}};
          \stopaxis
        \stoptikzpicture
      \stopTEXpage
    \stopbuffer
