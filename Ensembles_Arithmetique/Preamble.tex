...
\loadmarkfile{Ensembles_Arithmetique/Resources/buff-imp-haskell}
\loadmarkfile{Ensembles_Arithmetique/Resources/buff-imp-rust}
...
%% Corrections for the math font
%\appendtoks
%  \Umathsubshiftdown\allmathstyles .5ex
%  \Umathsubsupshiftdown\allmathstyles .5ex
%  \Umathsubsupvgap\allmathstyles .1ex
%\to \everymathematics
...
\setupnote[footnote][
  rule=off,
  before=\blank[line]\hrule\blank[quarterline,samepage],
]
...
\startnotmode[export] 
  \define{\p}{^\prime}
  \define{\pp}{^\prime\kern-.3ex^\prime}
\stopnotmode
\startmode[export]
  \define{\p}{'}
  \define{\pp}{''}
...
interfaces.implement {
  ...
  actions   = function(hash, content)
    ...
    context(
      ...
      .. "\\doifmode{*list}{\\vskip1ex\\hrule\\startcolumns[n=2,internalgrid=halfline]\\setuplocalinterlinespace[off]\\placecontent\\stopcolumns\\vskip{-1.5ex}"
...
\definecolor[coloredFrameColor][r=0.4,g=0.8,b=1]
\definetextbackground
  [coloredFrame]
  [mp=mp:coloredframe,
   location=paragraph,
