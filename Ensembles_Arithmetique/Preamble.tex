...
% Define indices
\startnotmode[export]
  \define[1]\wordsregisterTextCommand{{\setcharactercasing[Word]#1}}
  \defineregister[wordsRegister][
    pagestyle=,
    alternative=A,
    pageleft=\dotfill,
    n=3,
    textcommand=\wordsregisterTextCommand,
    method={pm,mc,uc}]
  \definelist[symbolsList][
    criterium=all,
    interaction=page,
    alternative=c]
  \define[1]\words{\wordsRegister{#1}#1}
...
\define\chaptertoc{%
  ...
  \doifmode{*list}{\vskip1ex\hrule\vskip-1ex\placecontent\hrule}%
}
