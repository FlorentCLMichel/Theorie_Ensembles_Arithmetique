...
\define[1]\imagebuffer{
  \startimage
    \getbuffer[#1]
  \stopimage}
\define[1]\hboxExport{\hbox{#1}} % To avoid issues due to line breaks within a word 
\stopmode
\startnotmode[export] 
...
\define\chaptertoc{%
  ...
  \doifmode{*list}{\vskip1ex\hrule\startsimplecolumns[n=2]\placecontent\stopsimplecolumns\hrule}%
}
