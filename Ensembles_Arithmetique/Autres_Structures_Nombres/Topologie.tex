...
\noindent\bold{Définition :} Soit $E$ un ensemble.
    Un ensemble $T$ est une \emph{\words{topologie} sur $E$} si les conditions suivantes sont satisfaites ; le couple $(E, T)$ est alors dit \emph{\words{espace topologique}} et les éléments de $T$ sont ses \emph{ouverts}\wordsRegister{ouvert} :
