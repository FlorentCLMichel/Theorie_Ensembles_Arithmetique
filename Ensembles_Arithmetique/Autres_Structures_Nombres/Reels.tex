...
\noindent\bold{Démonstration :} 
    ...
    On peut choisir un entier naturel $n_0$ tel que $\fabs{u_n - u_m} \leq 1$ pour tous entiers naturels $n$ et $m$ supérieurs ou égaux à $n_0$. 
    Soit $E$ l'ensemble $\left\lbrace \fabs{u_0}, \fabs{u_1}, \dots, \fabs{u_{n_0 - 1}}, \fabs{u_{n_0}} + 1 \right\rbrace$. 
    ...
    Si $n < n_0$, alors $\fabs{u_n} \in E$, donc $\fabs{u_n} \leq M$.
    Sinon, on a $\fabs{u_n - u_{n_0}} \leq 1$, donc, d'après l'inégalité triangulaire, $\fabs{u_n} - \fabs{u_{n_0}} \leq 1$, donc $\fabs{u_n} \leq \fabs{u_{n_0}} + 1$.
    Puisque $\fabs{u_{n_0}} + 1 \in E$, $\fabs{u_{n_0}} + 1 \leq M$, donc $u_n \leq M$. 

    Pour tout entier naturel $n$, on a donc $\fabs{u_n} \leq M$, et donc $-M \leq u_n \leq M$.
...
\noindent\bold{Démonstration :} Voir démonstration du théorème équivalent pour les nombres rationnels page \pageref{demo:rel_puissances_q} en remplaçant $q$ par $x$.
