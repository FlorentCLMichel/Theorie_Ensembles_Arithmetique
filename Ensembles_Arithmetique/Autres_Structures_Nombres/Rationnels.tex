...
\noindent\bold{Définition :} On définit les trois opérations $+$ (\emph{addition}), $-$ (\emph{soustraction}) et $\times$ (\emph{multiplication}) de $\mathbb{Q} \times \mathbb{Q}$ vers $\mathbb{Q}$ et l'opération $\divslash$ (\emph{division}) de $\mathbb{Q} \times \mathbb{Q}^*$ vers $\mathbb{Q}$ de la manière suivante. \index{Addition}\index{Soustraction}\index{Multiplication}\index{Division} 
...
\noindent\bold{Démonstration :}\label{demo:rel_puissances_q} 
...
\noindent\bold{Définition :} \index{Valeur absolue} \sindex[isy]{$\abs{\cdot}$}
