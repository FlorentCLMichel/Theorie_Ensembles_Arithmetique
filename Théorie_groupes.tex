...
\noindent\textbf{Définition :} Soit $(G, \cdot)$ un groupe abélien et $(H, \cdot)$ un sous-groupe de $(G, \cdot)$.
    On définit l'ensemble $G \divshlash H$ comme l'ensemble des classes d'équivalences de $G$ pour la relation $R$ définie par : $\forall g \in G \, \forall g' \in G \, g R g' \Leftrightarrow g^{-1} \cdot g' \in H$, oú un exposant $-1$ indiaue l'inverse. 
    Pour tout élément $g$ de $G$, on note $\bar{g}$ la classe d'équivalence de $g$ pour $R$.
    On définit la loi de composition interne $\cdot$ sur $G \divslash H$ de la manière suivante : soit $c_1$ et $c_2$ deux éléments de $G \divslash H$, on peut choisir un éléments $g_1$ de $c_1$ et un élément $g_2$ de $c_2$ ; on pose alors $c_1 \cdot c_2 = \overbar{g_1 \cdot g_2}$. 
    Alors, 
    \begin{itemize}[nosep]
...
\noindent\textbf{Démonstration :} Pour le premier point, il s'agit de montrer que le résultat ne dépends pas du choix de $g_1$ et $g_2$.
    ...
    Puisque $(H, \cdot)$ est un groupe, on en déduit que $(g_1 \cdot g_2)^{-1} \cdot (g_3 \cdot g_4) \in H$, donc $(g_1 \cdot g_2) R (g_3 \cdot g_4)$, et donc $\overbar{g_1 \cdot g_2} = \overbar{g_3 \cdot g_4}$.
    ...
    \begin{itemize}[nosep]
        ...
        \item Commutativité : Soit $c_1$ et $c_2$ deux éléments de $G \divslash H$.
            ...
            On a : $c_1 \cdot c_2 = \overbar{g_1 \cdot g_2}$ et $c_2 \cdot c_1 = \overbar{g_2 \cdot g_1}$.
        ...
        \item Soit $e$ l'élément neutre de $(G, \cdot)$. 
            ...
            On a : $c \cdot \bar{e} = \overbar{g \cdot e} = \bar{g} = c$.
        ...
        \item Associativité : Soit $c_1$, $c_2$ et $c_3$ trois éléments de $G \divslash H$.
            ...
            On a : $c_1 \cdot (c_2 \cdot c_3) = c_1 \cdot \overbar{g_2 \cdot g_3} = \overbar{g_1 \cdot (g_2 \cdot g_3)} = \overbar{(g_1 \cdot g_2) \cdot g_3} = \overbar{g_1 \cdot g_2} \cdot c_3 = (c_1 \cdot c_2) \cdot c_3$.
        \item Soit $c$ un élément de $G \divslash H$ et $g$ un élément de $c$. 
            Notons $g^{-1}$ l'inverse de $g$ et $e$ l'élément neutre de $(G,\cdot)$. 
            Alors, $c \cdot \bar{g^{-1}} = \overbar{g \cdot g^{-1}} = \bar{e}$.
